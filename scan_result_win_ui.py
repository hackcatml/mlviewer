# Form implementation generated from reading ui file 'scan_result_win.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.startScanBtn = QtWidgets.QPushButton(parent=Form)
        ...
        self.startScanBtn.setMinimumSize(QtCore.QSize(80, 0))
        ...
        self.scanMatchFoundLabel = QtWidgets.QLabel(parent=Form)
        ...
        self.scanPercentProgressLabel = QtWidgets.QLabel(parent=Form)
        ...
        # self.memScanResultTableWidget = QtWidgets.QTableWidget(parent=Form)
        self.memScanResultTableWidget = MemScanResultTableWidget(Form)
        font = QtGui.QFont()
        font.setFamily("Courier New")
        self.memScanResultTableWidget.setFont(font)
        ...
        self.memScanExcludePath = QtWidgets.QTextEdit(parent=Form)
        ...
        self.memScanExcludePath.setMinimumSize(QtCore.QSize(190, 26))
        self.memScanExcludePath.setMaximumSize(QtCore.QSize(16777215, 26))
